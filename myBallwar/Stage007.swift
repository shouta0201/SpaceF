...
class Stage007: SKScene, SKPhysicsContactDelegate, AVAudioPlayerDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        //ステージプロパティ///////////////////////////////////////////
        gsCore.speedvelocity = 250   //スピード設定
        gsCore.stageSuu = "7"      //ステージ数
        if appDelegate.gameMode == "normal" {
            gsCore.sksName = "Stage007_normal.sks"
        }else {
            gsCore.sksName = "Stage007.sks"
        }
        gsCore.goalPotision = -9000  //ゴールポジション -9500デフォルト
        ...
        gsCore.hCount = 15		//縦の画面数  1は667ピクセル
        gsCore.wCount = 15		//幅の画面数  1は375ピクセル
        ...
        // 再生する音源のURLを生成
        if appDelegate.audiomusic != "Fstage7" {
            appDelegate.audiomusic = "Fstage7"
