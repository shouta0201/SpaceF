...
class Stage003: SKScene, SKPhysicsContactDelegate, AVAudioPlayerDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        //ステージプロパティ///////////////////////////////////////////
        gsCore.speedvelocity = 100   //スピード設定
        gsCore.stageSuu = "3"      //ステージ数
        if appDelegate.gameMode == "normal" {
            gsCore.sksName = "Stage003_normal.sks"
        }else {
            gsCore.sksName = "Stage003.sks"
        }
        gsCore.goalPotision = -2500  //ゴールポジション　-2700
        gsCore.playerBodyCircle = 6  //プレイヤーあたり判定半径
        gsCore.scrollBool = true   //スクロールOnOff
        gsCore.scrollSpeed = 600    //スクロールスピード. ex 20000ピクセル 600秒でスロー
