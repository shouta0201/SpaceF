...
class Stage002: SKScene, SKPhysicsContactDelegate, AVAudioPlayerDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        gsCore.stageSuu = "2"      //ステージ数
        if appDelegate.gameMode == "normal" {
            gsCore.sksName = "Stage002_normal.sks"
        }else {
            gsCore.sksName = "Stage002.sks"
        }
        gsCore.goalPotision = -6500  //ゴールポジション　-6500
        ...
        gsCore.wCount = 2		//幅の画面数  1は375ピクセル
