...
class Stage001: SKScene, SKPhysicsContactDelegate, AVAudioPlayerDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        gsCore.stageSuu = "1"      //ステージ数
        if appDelegate.gameMode == "normal" {
                gsCore.sksName = "Stage001_normal.sks"
        }else {
                gsCore.sksName = "Stage001.sks"
        }
        gsCore.goalPotision = -8000  //ゴールポジション -5500デフォルト
